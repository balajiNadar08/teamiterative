...
export default function Documentation() {
  const [selectedDisease, setSelectedDisease] = useState<Disease | null>(docsData[0]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <div className="flex min-h-[calc(100vh-72px)]">
        ...
        {/* Sidebar */}
        <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-10 w-80 bg-white shadow-xl transition-transform duration-300 ease-in-out`}>
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-xl font-bold text-gray-800 mb-2">AYUSH Diseases</h2>
            <p className="text-sm text-gray-600">Click on any NAMASTE code to view details</p>
        ...
        <div className="flex-1 lg:ml-0 p-6">
          ...
          {selectedDisease ? (
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-5xl mx-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="bg-green-50 p-4 rounded-lg">
                      <div className="mb-3">
                        <span className="font-semibold text-green-800">Medicine Name:</span>
                        <span className="ml-2 text-gray-700 font-medium">
                          {selectedDisease.medicine}
                        </span>
                      </div>
                      <div className="mb-3">
                        <span className="font-semibold text-green-800">About Medicine:</span>
                        <p className="text-gray-700 mt-1">
                          {selectedDisease.aboutMedicine}
                        </p>
                      </div>
                      <div>
                        <span className="font-semibold text-green-800">Dosage:</span>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="bg-purple-50 p-4 rounded-lg">
                        <div className="font-semibold text-purple-800 mb-2">NAMASTE Code</div>
                      ...
                      <div className="bg-blue-50 p-4 rounded-lg">
                        <div className="font-semibold text-blue-800 mb-2">ICD-11 Biomedicine</div>
                      ...
                      <div className="bg-green-50 p-4 rounded-lg">
                        <div className="font-semibold text-green-800 mb-2">ICD-11 TM2</div>
                      ...
                      <div className="bg-yellow-50 p-4 rounded-lg">
                        <div className="font-semibold text-yellow-800 mb-2">SNOMED CT</div>
                      ...
                      <div className="bg-red-50 p-4 rounded-lg">
                        <div className="font-semibold text-red-800 mb-2">LOINC</div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div className="bg-white p-2 rounded text-center">
                        <div className="font-bold text-blue-600">Total Diseases</div>
                        <div className="text-gray-700">{docsData.length}</div>
                      </div>
                      <div className="bg-white p-2 rounded text-center">
                        <div className="font-bold text-green-600">Current Index</div>
                        <div className="text-gray-700">
                          {docsData.findIndex(d => d.namaste === selectedDisease.namaste) + 1}
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <div className="flex justify-between items-center">
                  <button
                    onClick={() => {
                      const currentIndex = docsData.findIndex(d => d.namaste === selectedDisease.namaste);
                      if (currentIndex > 0) {
                        setSelectedDisease(docsData[currentIndex - 1]);
                      }
                    }}
                    disabled={docsData.findIndex(d => d.namaste === selectedDisease.namaste) === 0}
                  ...
                  <div className="text-sm text-gray-500">
                    {docsData.findIndex(d => d.namaste === selectedDisease.namaste) + 1} of {docsData.length}
                  </div>
                  ...
                  <button
                    ...
                    disabled={docsData.findIndex(d => d.namaste === selectedDisease.namaste) === docsData.length - 1}
                    className="flex items-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    Next
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">No Disease Selected</h3>
              <p className="text-gray-600">Select a NAMASTE code from the sidebar to view details</p>
            </div>
          )}
        </div>
      </div>
